...
const defaultLabelsRaw = {
  zh: '其他', en: 'other', ja: 'その他', ko: '기타', de: 'andere', fr: 'autre', es: 'otro', ru: 'Другое'
};
const typeLabelsRaw: Record<string, Record<string, string>> = {
  chatbot: {
    zh: '聊天机器人', en: 'chatbot', ja: 'チャットボット', ko: '챗봇', de: 'chatbot', fr: 'chatbot', es: 'chatbot', ru: 'Чат-бот'
  },
  image: {
    zh: '图像生成', en: 'image_generation', ja: '画像生成', ko: '이미지 생성', de: 'bildgenerierung', fr: "Génération d'images", es: 'Generación de imágenes', ru: 'Генерация изображений'
  },
  coding: {
    zh: '编程', en: 'coding', ja: 'コーディング', ko: '코딩', de: 'programmierung', fr: 'codage', es: 'codificación', ru: 'Кодирование'
  },
  productivity: {
    zh: '生产力', en: 'productivity', ja: '生産性', ko: '생산성', de: 'produktivität', fr: 'productivité', es: 'productividad', ru: 'Продуктивность'
  },
  design: {
    zh: '设计', en: 'design', ja: 'デザイン', ko: '디자인', de: 'design', fr: 'conception', es: 'diseño', ru: 'Дизайн'
  },
  writing: {
    zh: '写作', en: 'writing', ja: 'ライティング', ko: '글쓰기', de: 'schreiben', fr: 'écriture', es: 'escritura', ru: 'Письмо'
  },
  media: {
    zh: '媒体', en: 'media', ja: 'メディア', ko: '미디어', de: 'medien', fr: 'médias', es: 'medios', ru: 'Медиа'
  },
  marketing: {
    zh: '营销', en: 'marketing', ja: 'マーケティング', ko: '마케팅', de: 'marketing', fr: 'marketing', es: 'marketing', ru: 'Маркетинг'
  },
  app: {
    zh: '应用', en: 'app', ja: 'アプリ', ko: '앱', de: 'app', fr: 'application', es: 'aplicación', ru: 'Приложение'
  }
};
const featuredRaw = [
  {
  ...
  {
    name: 'soul_machines',
    desc: 'global_leader_in_humanizing_ai',
    icon: 'https://www.soulmachines.com/favicon.ico',
  },
  {
    name: 'salesape_ai',
    desc: 'your_ai_sales_representative',
...
export default function ToolGrid() {
  ...
  // 动态生成 defaultLabels、typeLabels、featured
  const defaultLabels = {
    zh: '其他',
    en: t('auto_other_6311ae'),
    ja: 'その他',
    ko: '기타',
    de: t('auto_andere_0f9580'),
    fr: t('auto_autre_977a72'),
    es: t('auto_otro_c22952'),
    ru: 'Другое'
  };
  const typeLabels: Record<string, Record<string, string>> = {
    chatbot: {
      zh: '聊天机器人',
      en: t('auto_chatbot_60b4e9'),
      ja: 'チャットボット',
      ko: '챗봇',
      de: t('auto_chatbot_60b4e9'),
      fr: t('auto_chatbot_60b4e9'),
      es: t('auto_chatbot_60b4e9'),
      ru: 'Чат-бот'
    },
    image: {
      zh: '图像生成',
      en: t('auto_image_generation_c7a4b1'),
      ja: '画像生成',
      ko: '이미지 생성',
      de: t('auto_bildgenerierung_e67da8'),
    ...
    coding: {
      zh: '编程',
      en: t('auto_coding_cddcad'),
      ja: 'コーディング',
      ko: '코딩',
      de: t('auto_programmierung_92fddb'),
      fr: t('auto_codage_3c3323'),
      es: 'Codificación',
      ru: 'Кодирование'
    },
    productivity: {
      zh: '生产力',
      en: t('auto_productivity_73015e'),
      ja: '生産性',
      ko: '생산성',
      de: 'Produktivität',
      fr: 'Productivité',
      es: t('auto_productividad_5469dc'),
      ru: 'Продуктивность'
    },
    design: {
      zh: '设计',
      en: t('auto_design_1afa74'),
      ja: 'デザイン',
      ko: '디자인',
      de: t('auto_design_1afa74'),
      fr: t('auto_conception_994179'),
      es: 'Diseño',
      ru: 'Дизайн'
    },
    writing: {
      zh: '写作',
      en: t('auto_writing_af96ab'),
      ja: 'ライティング',
      ko: '글쓰기',
      de: t('auto_schreiben_081059'),
      fr: 'Écriture',
      es: t('auto_escritura_95ac64'),
      ru: 'Письмо'
    },
    media: {
      zh: '媒体',
      en: t('auto_media_3b5635'),
      ja: 'メディア',
      ko: '미디어',
      de: t('auto_medien_5296a6'),
      fr: 'Médias',
      es: t('auto_medios_e81c44'),
      ru: 'Медиа'
    },
    marketing: {
      zh: '营销',
      en: t('auto_marketing_7cb15e'),
      ja: 'マーケティング',
      ko: '마케팅',
      de: t('auto_marketing_7cb15e'),
      fr: t('auto_marketing_7cb15e'),
      es: t('auto_marketing_7cb15e'),
      ru: 'Маркетинг'
    },
    app: {
      zh: '应用',
      en: t('auto_app_ac863f'),
      ja: 'アプリ',
      ko: '앱',
      de: t('auto_app_ac863f'),
      fr: t('auto_application_e49874'),
      es: 'Aplicación',
      ru: 'Приложение'
    }
  };
