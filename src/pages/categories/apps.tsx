...
export default function AIApps() {
  ...
  return (
    <div className="py-8 max-w-6xl mx-auto">
      <h1 className="text-2xl font-bold mb-8 text-center">{lang === 'zh' ? 'AI Apps' : 'AI Apps'}</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {apps.length === 0 ? <div className="col-span-4 text-center text-gray-400">暂无AI App工具</div> :
